---
title: "Model Performance - Decision Tree"
...
y1x1 <- '100%'
library(rpart)
model <- rpart(y ~ age + job + marital + education + default + balance + housing + loan + contact + duration + campaign + pdays + previous + poutcome, data = raw_data)
```
...
confusion <- table(test_data$y, predict(model,test_data[,features], type='class'))
